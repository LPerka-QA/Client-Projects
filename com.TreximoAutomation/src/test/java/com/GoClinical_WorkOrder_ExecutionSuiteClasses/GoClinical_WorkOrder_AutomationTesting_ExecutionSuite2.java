...
public class GoClinical_WorkOrder_AutomationTesting_ExecutionSuite2 {
		...
		//private static AdminUser_LoginPageData AdminUserReviewRecords = null;
			...
			public void TestSetup(String browserName) throws IOException, BiffException {
				...
				String ReportName = Name+"_"+ timeStamp+".html";*/
										...
										HTMLReportPAth = System.getProperty("user.dir") + "\\Resources\\Reports\\Full Execution\\GoClinical Work Order Automation Testing Test Suite.html";
										CurrentPageTestCaseName = "GoClinical Work Order Automation Testing Test Suite";
			...
			public void NurseUserMyWorkOrders() throws IOException, InterruptedException, BiffException {
				...
				ExcelSheetPath2 = System.getProperty("user.dir") + "\\Resources\\TestData\\MyWorkOrders_AutoTestingForm_TestData.xls";
				Excel_SheetName2 = "My Work Orders";
				WritePath2 = System.getProperty("user.dir") + "\\Resources\\TestData\\MyWorkOrders_AutoTestingForm_TestData.xls";
			...
			public void AdminUserReviewRecords() throws IOException, InterruptedException, BiffException, WriteException {
				...
				ExcelSheetPath3 = System.getProperty("user.dir") + "\\Resources\\TestData\\MyWorkOrders_AutoTestingForm_TestData.xls";
				Excel_SheetName3 = "My Work Orders";
				WritePath3 = System.getProperty("user.dir") + "\\Resources\\TestData\\MyWorkOrders_AutoTestingForm_TestData.xls";
